      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="my-job-post.php"><i class="fa fa-file-o"></i> My Project Post</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2><i>My Project Posts</i></h2>
            <p>Pada menu ini anda dapat melihat proyek-proyek yang telah anda post.</p>
